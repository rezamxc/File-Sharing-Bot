...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6852366542:AAEh7V8hyfJUO1FCCv9muzmwtsF7hShlFKU")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001519920395"))
...
USER_REPLY_TEXT = "❌Don't send me messages directly बहनचोद!"
